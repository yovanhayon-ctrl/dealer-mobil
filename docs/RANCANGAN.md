...
- Hapus mobil ditolak jika punya test drive, pengajuan, atau promo (`Car::DELETION_BLOCKERS`); admin disarankan menonaktifkan. File gambar mobil saat dihapus ditangani di Phase 7.
